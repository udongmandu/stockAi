...
## 간단 설명 : 해당 프로그램은 크롤링 한 뉴스를 이용하여 OpenAI 를 통해 해당 뉴스의 호재/악재를 판단 한 후, 해당 주식에 대한 정보를 반환해 주는 프로그램이다.
...
사용 방법 : 
  ...
  ## V2 추가 ) [챗봇기능] 쌓인 데이터를 이용하여 RAG구조를 통해 AI 가 직접 필요한 데이터를 가져와 분석하여 대답하는 기능
  + 데이터 별로 영향을 많이 준다고 판단 되는 것은 추가 가중치를 주고, 카테고리를 나누는 것으로 최대한 자세한 데이터를 줄 수 있도록 설정 하였
  <img width="1829" height="853" alt="image" src="https://github.com/user-attachments/assets/e747d749-3971-40ba-aeb2-2e82b2476fce" />
